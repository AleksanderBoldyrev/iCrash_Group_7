...
1.a Download from http://dev.mysql.com/downloads/ and
 install it.

2. Open a terminal and execute the following commands:
2.1 cd  [PATH_TO_THE_ICRASH_DATABASE_JAVA_PROJECT]/scripts
2.2 mysql 
-u root -p  < icrash_db_create.sql
...
2. Import the DATABASE iCrash
 Java Development project into your workspace. 
...
What's next?
----------------------------------
The project DATABASE contains several simple examples meant to allow the user to test
 whether 
...
1. Open the class 
respective to the test of interest contained in the the package 
lu.uni.lassy.excalibur.examples.icrash.dev.java.testcases

2.
 Right-click on the class and then select Run as -> Java Application

Below, the test cases that have been implemented:
1. test
 if the database has been properly set-up: class TestCase_db_alive
2. test insert/select/delete SQL statements on the Alerts table of
 the icrash DB.  
3. test insert/select/delete SQL statements on the Crises table of the icrash DB.
4. test insert/select/delete SQL
 statements on the Humans table of the icrash DB.
